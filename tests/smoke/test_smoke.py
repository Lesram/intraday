...
class StagingTestClient:
    ...
    def __init__(self, base_url: str, timeout: int = 10):
        ...
        self.session.headers.update({
            'User-Agent': 'AlgoTrading-SmokeTest/1.0',
...
class TestSystemAPI:
    ...
    def test_api_root_accessible(self, client, wait_for_ready):
        ...
        assert response.status_code in [200, 404, 405], f"Unexpected root response: {response.status_code}"
...
class TestAuthenticationSmoke:
    ...
    def test_login_endpoint_exists(self, client, wait_for_ready):
        ...
        assert response.status_code in [400, 401, 422], f"Login endpoint missing or broken: {response.status_code}"
    ...
    def test_protected_endpoint_rejects_unauthenticated(self, client, wait_for_ready):
        ...
        for endpoint in protected_endpoints:
            ...
            assert response.status_code in [401, 403], f"Endpoint {endpoint} not properly protected: {response.status_code}"
...
class TestErrorHandling:
    ...
    def test_method_not_allowed_handling(self, client, wait_for_ready):
        ...
        assert response.status_code in [405, 404], f"Unexpected method response: {response.status_code}"
