...
from tests.conftest import patch_middleware_globals, TestMetricsRegistry
...
class TestMiddlewareIsolation:
    ...
    def test_patch_middleware_globals_context_manager(self, mock_structured_logger, test_metrics_registry):
        ...
        with patch_middleware_globals(test_logger=mock_structured_logger, test_metrics=test_metrics_registry):
            client = TestClient(app)
            response = client.get("/test")
