...
1. OrderEvent model for trade update deduplication
...
"""
from sqlalchemy import Column, String, DateTime, Integer, Numeric, Date, JSON, ForeignKey, UniqueConstraint, Index
...
class OrderEvent(Base):
    ...
    event_type = Column(String(50), nullable=False)  # trade_update, fill, cancel, etc.
    event_time = Column(DateTime(timezone=True), nullable=False)
    event_data = Column(JSON, nullable=True)  # Raw event payload for debugging
