"""
Database connection and session management (package form).
This package exposes the same public API previously provided by the
flat module, and enables imports like ``backend.database.connection``.
"""
