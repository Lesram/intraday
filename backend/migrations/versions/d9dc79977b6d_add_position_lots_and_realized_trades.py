"""add_position_lots_and_realized_trades

Revision ID: d9dc79977b6d
Revises: 76f317122560
Create Date: 2025-10-14 22:03:55.989664
...
Design Decision (M-24): user_id is String(100) intentionally to store JWT username claims
instead of referencing User.id (Integer). This allows lot/trade tracking for API users
that may not have database User records, and simplifies JWT-based access control.
Tables that reference User.id use Integer; tables that reference username use String.
"""
...
revision: str = 'd9dc79977b6d'
down_revision: str | Sequence[str] | None = '76f317122560'
