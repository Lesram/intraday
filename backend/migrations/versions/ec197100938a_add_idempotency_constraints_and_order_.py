...
down_revision: Union[str, Sequence[str], None] = '706e00fe1a28'
...
def upgrade() -> None:
    ...
    try:
        ...
        print(f"⚠️ order_events table creation skipped: {e}")
    ...
    try:
        ...
        print(f"⚠️ daily_ledger table creation skipped: {e}")
    ...
    try:
        ...
        print(f"⚠️ account_id column already exists: {e}")
    ...
    try:
        ...
        print("✅ Created daily_ledger index")
    except Exception as e:
        print(f"⚠️ daily_ledger index skipped: {e}")
