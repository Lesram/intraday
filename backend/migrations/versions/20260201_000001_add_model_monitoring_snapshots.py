...
§11.2 FIX: FK to model_registry is now valid since model_registry is created in 706e00fe1a28.

Revision ID: 20260201_000001
Revises: add_user_id_orders
...
down_revision = "add_user_id_orders"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["model_id"],
            ["model_registry.id"],
            name=op.f("fk_model_monitoring_snapshots_model_id_model_registry"),
            ondelete="SET NULL",
        ),
    )
