...
class OrderState(Enum):
    ...
    def terminal_states(cls) -> Set['OrderState']:
        ...
        return {
            cls.FILLED, cls.CANCELLED, cls.REJECTED, 
            cls.EXPIRED, cls.FAILED
        }
    ...
    def active_states(cls) -> Set['OrderState']:
        ...
        return {
            cls.VALIDATED, cls.RISK_APPROVED, cls.PENDING_SUBMISSION,
            cls.SUBMITTED, cls.PENDING_EXECUTION, cls.PARTIALLY_FILLED
        }
...
class OrderStateMachine:
    ...
    def can_transition(self, from_state: OrderState, to_state: OrderState, trigger: TransitionTrigger) -> bool:
    ...
    def get_valid_transitions(self, current_state: OrderState) -> Dict[TransitionTrigger, OrderState]:
...
class AuditLogger:
    ...
    async def get_order_audit_trail(self, order_id: str) -> List[AuditLogEntry]:
        ...
        query = self.db_session.query(AuditLogEntry).filter(
            AuditLogEntry.entity_id == order_id
...
class OrderIntegrityService:
    ...
    async def transition_order_state(self,
                                   order_id: str,
                                   from_state: OrderState,
                                   to_state: OrderState,
                                   trigger: TransitionTrigger,
