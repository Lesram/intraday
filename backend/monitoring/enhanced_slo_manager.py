...
class EnhancedSLOManager:
    ...
    def record_metric_value(self, slo_name: str, value: float, timestamp: datetime | None = None):
        """
...
async def main():
    ...
    # Adjust command
    subparsers.add_parser('adjust', help='Force threshold adjustment evaluation')

    # Report command
    subparsers.add_parser('report', help='Generate threshold adjustment report')
