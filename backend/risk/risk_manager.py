...
class RiskManager:
    ...
    def __init__(self, portfolio=None, risk_limits: Optional[RiskLimits] = None):
        """
    ...
    def before_order(
        self, symbol: str, intended_qty: float, price: Optional[float] = None
    ...
    def _trigger_circuit_breaker(self, reason: str, value: float):
        ...
        if not self.circuit_breaker_active:
            ...
            audit_logger.log_risk_event(
                ...
                severity="CRITICAL",
                data={"reason": reason, "value": value, "timestamp": datetime.now(timezone.utc)},
            )
    ...
    def get_risk_metrics(self) -> PortfolioRisk:
        ...
        try:
            ...
            elif abs(daily_return) > self.limits.max_daily_loss_pct * 0.8:
    ...
    def reset_circuit_breaker(self, reason: str):
        ...
        if self.circuit_breaker_active:
            ...
            audit_logger.log_risk_event(
                ...
                severity="INFO",
                data={"reason": reason, "timestamp": datetime.now(timezone.utc)},
            )
