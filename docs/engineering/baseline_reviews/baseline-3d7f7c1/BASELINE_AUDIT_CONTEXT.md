...
### `live_engine.py` (4,076 lines) — the core
...
6. **Inverse ETFs** (SH, PSQ) have flipped regime alignment — trending_down is bullish for inverse ETFs.
