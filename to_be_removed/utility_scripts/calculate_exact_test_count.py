#!/usr/bin/env python3
"""
Parse pytest collection output and calculate total tests
"""

test_data = """test_b24_infrastructure.py: 3
test_b24_outbox_comprehensive.py: 19
test_b26_mlops_registry.py: 16
test_b28_risk_manager_full.py: 4
test_client_deep_fix.py: 1
test_client_enhanced.py: 1
test_client_fix.py: 2
test_client_ultimate.py: 1
test_comprehensive.py: 8
test_comprehensive_light_mode.py: 2
test_comprehensive_old.py: 8
test_config_simple.py: 4
test_deployment_readiness.py: 5
test_deployment_validation.py: 6
test_e_constructor_improvements.py: 4
test_f_integration.py: 3
test_f_risk_math_normalization.py: 6
test_integration.py: 1
test_isolated.py: 2
test_light_mode.py: 2
test_light_mode_final.py: 1
test_mlops_simple.py: 6
test_pandas_error_fix.py: 3
test_persistence_comprehensive.py: 1
test_phase_2a_register.py: 1
test_prompt_4.py: 2
test_prompt_4_comprehensive.py: 2
test_prompt_5.py: 4
test_prompt_6.py: 5
test_prompt_7.py: 6
test_risk_gate_order_flow.py: 11
test_risk_manager_comprehensive.py: 22
test_risk_math_edges.py: 30
test_simple_ws.py: 1
test_strategy_netting.py: 8
test_strategy_to_order_flow.py: 8
test_testclient_issue.py: 2
tests/api/test_api_main_import.py: 1
...
print(f"🎯 DEFINITIVE TOTAL TEST COUNT: {total}")
...
for line in lines:
    ...
    if match:
        ...
        if line.startswith('tests/'):
            tests_dir_tests += count
        else:
            root_tests += count

print(f"\nBreakdown:")
print(f"Root directory tests: {root_tests}")
print(f"tests/ directory tests: {tests_dir_tests}")
print(f"Total: {root_tests + tests_dir_tests}")
